package com.example.resturantdlv.Sellers;
...
public class SellerRegistrationActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        sellerLoginBegin = findViewById(R.id.seller_altready_have_account_btn);
        registerButton = findViewById(R.id.seller_login_btn);
