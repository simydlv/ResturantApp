...
public class AdminMaintainProductsActivity extends AppCompatActivity
{
    ...
    private Button appiyChangesBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appiyChangesBtn = findViewById(R.id.apply_changes_btn);
        name = findViewById(R.id.product_name_maintain);
        price = findViewById(R.id.product_Prices_maintain);
        ...
        appiyChangesBtn.setOnClickListener(new View.OnClickListener() {
            @Override
