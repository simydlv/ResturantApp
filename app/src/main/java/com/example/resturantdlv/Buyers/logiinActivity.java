...
public class logiinActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ForgetPasswordLink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                Intent intent = new Intent(logiinActivity.this, ResetPasswordActivity.class);
        ...
        NotAdmine.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Toast.makeText(logiinActivity.this, "Please write your  phone ...", Toast.LENGTH_SHORT).show();
            }
            else  if (TextUtils.isEmpty(password))
            {
                Toast.makeText(logiinActivity.this, "Please write your  password ...", Toast.LENGTH_SHORT).show();
            }
            else
                   {
                      ...
                      if (dataSnapshot.child(parentDbName).child(phone).exists()) {
                          ...
                          if (users.getPhone().equals(phone)) {
                              if (users.getPassword().equals(password))
                              {
                                  ...
                                  {
                                      Toast.makeText(logiinActivity.this, "Welcome Admin, you are logged in Successfully ...", Toast.LENGTH_SHORT).show();
                                      loadingBar.dismiss();

                                      Intent intent = new Intent(logiinActivity.this, AdminCategoryActivity.class);
                                        startActivity(intent);

                                  }
                                  else if (parentDbName.equals("Users"))
                                  {
                                      Toast.makeText(logiinActivity.this, " logged in Successfully ...", Toast.LENGTH_SHORT).show();
                                      loadingBar.dismiss();

                                      Intent intent = new Intent(logiinActivity.this, HomeActivity2.class);
                                  ...
                                  loadingBar.dismiss();
                                  Toast.makeText(logiinActivity.this, " Password is incorrect ...", Toast.LENGTH_SHORT).show();
                              }

                          }

                      } else {
                          Toast.makeText(logiinActivity.this, " Account with this" + phone + "number do not exist .", Toast.LENGTH_SHORT).show();
                          loadingBar.dismiss();
